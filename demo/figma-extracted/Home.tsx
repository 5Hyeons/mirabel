...
// Figma에서 추출한 이미지 assets
// TODO: 실제 프로젝트에서는 public/images/ 폴더로 이동
const imgDoctorAvatar = "http://localhost:3845/assets/566b019bcb330bf030c5ac5b85b794bf9e73309a.png";
const imgIconArrowRight = "http://localhost:3845/assets/31b2bd24af4b6793ef9d988f3eca3c6b13f307e1.svg";
const imgIconGlobe = "http://localhost:3845/assets/0147c8eb845ff42ae8172d7d5bb3bfc957437bfc.svg";
    ...
    <div className="bg-[#6490ff] overflow-clip relative rounded-[8px] size-full min-h-screen" data-name="예약 확인 성공" data-node-id="77:6188">
      ...
      <div className="absolute h-[242.317px] left-[calc(62.5%+9.664px)] top-[95.55px] translate-x-[-50%] w-[262.672px]" data-name="_0036 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img
            alt="Doctor Avatar"
            className="absolute h-[383.53%] left-[-95.31%] max-w-none top-[-127.61%] w-[353.82%]"
            src={imgDoctorAvatar}
          />
        </div>
      </div>
      ...
      <div className="absolute bg-white border border-[#dddddd] border-solid box-border content-stretch flex flex-col gap-[16px] items-center justify-center left-1/2 px-[16px] py-[24px] rounded-[10px] top-[347.5px] translate-x-[-50%] w-[328px]">
        ...
        {/* 안내 문구 */}
        <div className="font-['Noto_Sans_KR:Regular',_sans-serif] font-normal leading-[1.4] relative shrink-0 text-[#111111] text-[14px] text-center tracking-[-0.28px] w-full">
