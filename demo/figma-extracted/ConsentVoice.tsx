...
// Figma 추출 이미지
const imgMicIcon = "http://localhost:3845/assets/650d683f0fb93f3e7591dbbb4ff3cc3fd0aca79c.png";
const imgIconMic = "http://localhost:3845/assets/35c719555cadc6c4cd65871b3b137bc976947d9a.svg";
const imgIconRefresh = "http://localhost:3845/assets/2d445e7d5260924b2aacea26dc24e9c7807ecf9c.svg";
const imgIconPlay = "http://localhost:3845/assets/8fd7a076c5ed902bba6b812ed4465c48753f1bbe.svg";
const imgIconArrowLeft = "http://localhost:3845/assets/2283d49da3c522b982b0e037529ce74c5ce65570.svg";
const imgIconHome = "http://localhost:3845/assets/0f466c9b3e849494cccc274f54cee555ada26e5c.svg";
      ...
      <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[16px] top-[116px] w-[328px]">
        ...
        <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
          <div className="relative shrink-0 size-[60px]">
            <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgMicIcon} />
          </div>
          ...
          {recordingState === 'recording' && (
            <div className="bg-[#ffcdcd] h-[56px] overflow-clip relative rounded-[8px] shrink-0 w-full flex items-center px-4">
              ...
              <div className="content-stretch flex gap-[5px] items-center">
                {[6, 6, 6, 6, 6, 6, 6, 15.805, 27.016, 7.43, 6, 6, 6, 6, 6, 6].map((height, i) => (
                  <div
                    key={i}
                    className="bg-[rgba(17,17,17,0.5)] rounded-[99px] shrink-0 w-[3px] transition-all"
