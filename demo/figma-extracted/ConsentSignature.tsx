...
// Figma 추출 이미지
const imgPenIcon = "http://localhost:3845/assets/0ecfcbcb1533e4e9b19ea6125e0f70c5ac432826.png";
const imgIconBin = "http://localhost:3845/assets/a7be57f757d722d30075e688ddd53da1155c6dcd.svg";
const imgDottedLine = "http://localhost:3845/assets/0899078d91b36ae786392c0575a63609cbd9e099.svg";
      ...
      <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[16px] top-[116px] w-[328px]">
        ...
        <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
          <div className="relative shrink-0 size-[60px]">
            <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgPenIcon} />
          </div>
        ...
        <div className="border-[#6490ff] border-[0px_0px_0px_2px] border-solid box-border content-stretch flex flex-col gap-[8px] items-start px-[20px] py-0 relative shrink-0 w-full">
          ...
          <div className="relative h-[150px] w-[308px]">
            ...
            {/* 점선 (서명 라인) */}
            <div className="absolute bottom-[12px] left-[13.531px] w-[280.946px] h-0">
              <img alt="" className="block max-w-none w-full" src={imgDottedLine} />
            </div>
          </div>
