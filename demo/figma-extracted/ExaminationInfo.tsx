...
const imgIconArrowLeft = "http://localhost:3845/assets/77b621c6591a28930e3f80610e44541056d18b10.svg";
const imgIconHome = "http://localhost:3845/assets/0f466c9b3e849494cccc274f54cee555ada26e5c.svg";

// 검사 정보 페이지 데이터 (mock-data.json에서 로드 가능)
...
export default function ExaminationInfo() {
  ...
  return (
    <div className="bg-[#f0f3ff] overflow-clip relative rounded-[8px] size-full min-h-screen" data-name="검사 안내" data-node-id="77:9114">
      ...
      {/* 스크롤 인디케이터 */}
      <div className="absolute bg-[rgba(0,0,0,0.25)] h-[126px] right-[20.39px] rounded-[99px] top-[265.5px] w-[2px]" />
    </div>
  );
}
