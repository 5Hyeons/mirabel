...
// Figma 추출 이미지
const imgCheckIcon = "http://localhost:3845/assets/4597f96e9d3bdae811ab0fceb0525a299caf06aa.svg";
const imgDoctorAvatar = "http://localhost:3845/assets/b609b97adb2ce89b2f6f0b31110e73c5610d087f.png";
const imgSpeechBubble = "http://localhost:3845/assets/c4a129aec504dd5452745679006d55b60fd73e1f.svg";
...
export default function ConsentComplete() {
  ...
  return (
    <div className="bg-white overflow-clip relative rounded-[8px] size-full min-h-screen" data-name="동의" data-node-id="89:6350">
      ...
      {/* 툴팁 (말풍선) */}
      <div className="absolute h-[72.449px] left-[16.26px] shadow-[0px_2.59px_12.952px_0px_rgba(0,0,0,0.2)] top-[632px] w-[153px]">
        ...
        {/* 말풍선 꼬리 */}
        <div className="absolute left-[25.62px] top-[51.57px] size-[20.883px] rotate-180">
