...
// Figma 추출 이미지
const imgDocumentIcon = "http://localhost:3845/assets/aa318136e91cda850efce3185146c3439cb2ebec.png";
const imgCheckIcon = "http://localhost:3845/assets/ae0da2373926501542ddd4a244c76169a3c57d5e.svg";
      ...
      <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[16px] top-[116px] w-[328px]">
        ...
        <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
          <div className="relative shrink-0 size-[60px]">
            <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgDocumentIcon} />
          </div>
        ...
        <div className="content-stretch flex items-center relative shrink-0 w-full">
          ...
          >
            ...
            <p className="basis-0 font-['Pretendard:Regular',_sans-serif] grow leading-[1.5] min-h-px min-w-px not-italic relative shrink-0 text-[16.734px] text-black tracking-[-0.3347px]">
              예 (필수)
            </p>
          </button>
